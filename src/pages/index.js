...
const IndexPage = () => {
  ...
  return (
    <main>
      <header className="bg-gradient-to-l from-grey-light to-white">
      ...
      <section className="gutter top" id="services">
        <div className="wrapper">
          ...
          <table className="hidden md:table text-left border-spacing-8 border-collapse w-full mb-12">
            ...
            <tbody className="th">
              <tr>
                ...
                <td><i className="fa-solid fa-check text-teal" /></td>
              </tr>
              <tr>
          ...
          <div className="md:hidden">
            <div className="feature p-6 shadow-lg mb-10">
              ...
              <div className="flex border-t border-grey-light py-3 gap-2 items-center">
                <div className="flex self-start"><i className="text-xl fa-solid fa-check mr-4 text-purple" /> 
                </div>
          ...
          <div className="feature p-6 shadow-lg mb-10">
              ...
              <div className="flex border-t border-grey-light py-3 gap-2 items-center">
                <div className="flex self-start"><i className="text-xl fa-solid fa-check mr-4 text-teal" /> 
                </div>
                <div className="text-sm">Explain Northrop Grumman’s health and well-being benefits</div>
              </div>
              <div className="flex border-t border-grey-light py-3 gap-2 items-center">
